...
class DoctorScheduleCreated extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('New Schedule Added by Doctor')
            ->greeting('Hello ' . $notifiable->name . '!')
            ->line('Dr. ' . $this->doctor->user->name . ' has added a new schedule.')
            ...
            ->line('The doctor can now accept appointments for this time slot.');
    }
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'message' => 'Dr. ' . $this->doctor->user->name . ' added a new schedule for ' . ucfirst($this->schedule->day_of_week),
            'type' => 'doctor_schedule_created',
        ];
    }
