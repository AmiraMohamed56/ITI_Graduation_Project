...
<div class="max-w-6xl mx-auto dark:bg-gray-900">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('medical_records.index') }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700/50">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-start justify-between mb-6">
                <div class="flex items-center gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $medicalRecord->patient->user->name }}</h2>
                        <div class="flex items-center gap-3 mt-2">
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                {{ $medicalRecord->patient->user->status === 'active' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->patient->blood_type }}</p>
                </div>
                @endif
                ...
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->patient->user->phone }}</p>
                </div>
                @endif

                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Email</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->patient->user->email }}</p>
                </div>

                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Account Status</p>
                ...
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Patient Since</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->patient->created_at->format('F Y') }}</p>
                </div>
            </div>

            @if ($medicalRecord->patient->chronic_diseases)
            <div class="mt-6">
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2 font-medium">Chronic Diseases</p>
                <div class="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800 p-4 rounded-lg">
                    <p class="text-gray-900 dark:text-gray-200">{{ $medicalRecord->patient->chronic_diseases }}</p>
                </div>
            </div>
            @endif
        </div>
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Medical Record Details</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Visit Date & Time</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->created_at->format('F d, Y \a\t h:i A') }}
                    </p>
                </div>

                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Last Updated</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->updated_at->format('F d, Y \a\t h:i A') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-800 p-4 rounded-lg">
                <p class="text-gray-900 dark:text-gray-200 whitespace-pre-line">{{ $medicalRecord->symptoms }}</p>
            </div>
        </div>
        @endif
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="bg-yellow-50 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800 p-4 rounded-lg">
                <p class="text-gray-900 dark:text-gray-200 whitespace-pre-line">{{ $medicalRecord->diagnosis }}</p>
            </div>
        </div>
        @endif
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Medication & Prescriptions</h3>
            <div class="bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-800 p-4 rounded-lg">
                <p class="text-gray-900 dark:text-gray-200 whitespace-pre-line">{{ $medicalRecord->medication }}</p>
            </div>
        </div>
        @endif
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                ...
                <span class="bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 text-xs font-bold px-2.5 py-1 rounded-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md dark:hover:shadow-gray-700/50 transition-shadow bg-white dark:bg-gray-800">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white truncate" title="{{ $fileName }}">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                ...
                                <button
                                    ...
                                    class="text-xs bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-3 py-1.5 rounded transition-colors flex items-center gap-1">
                                ...
                                <a href="{{ $fileUrl }}" target="_blank"
                                    class="text-xs bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 text-white px-3 py-1.5 rounded transition-colors flex items-center gap-1">
                                    <i class="fas fa-eye"></i>
                                    View PDF
                                </a>
                                @else
                                ...
                                <a href="{{ $fileUrl }}"
                                    class="text-xs bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white px-3 py-1.5 rounded transition-colors flex items-center gap-1">
                                    <i class="fas fa-eye"></i>
                                    Open
                                </a>
                                @endif
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="text-center py-8">
                <i class="fas fa-file-medical text-4xl text-gray-300 dark:text-gray-600 mb-3"></i>
                <p class="text-gray-500 dark:text-gray-400 text-lg">No medical details recorded yet</p>
                <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Add symptoms, diagnosis, medication information, and files</p>
            </div>
        </div>
        @endif

        <!-- Doctor Information Section (Optional - commented out) -->
        {{-- <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Attending Physician</h3>
        ...
        />
        <div class="flex-1">
            <p class="font-semibold text-gray-900 dark:text-white text-lg">Dr. {{ $medicalRecord->doctor->user->name }}</p>
            <p class="text-gray-600 dark:text-gray-400 text-sm">Doctor ID: #DR{{ str_pad($medicalRecord->doctor_id, 4, '0', STR_PAD_LEFT) }}</p>
        ...
        <div class="text-right">
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Record Created</p>
            <p class="text-gray-900 dark:text-white font-medium">{{ $medicalRecord->created_at->format('M d, Y') }}</p>
            <p class="text-gray-600 dark:text-gray-500 text-xs mt-1">{{ $medicalRecord->created_at->format('h:i A') }}</p>
        </div>
    </div>
</div> --}}
</div>
...
<div id="imageModal" class="hidden fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4">
    <div class="relative max-w-5xl w-full bg-white dark:bg-gray-800 rounded-lg overflow-hidden">
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <h3 id="modalFileName" class="text-lg font-semibold text-gray-900 dark:text-white"></h3>
            <button onclick="closeImageModal()" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white">
