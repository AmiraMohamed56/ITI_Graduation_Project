...
<div class="max-w-6xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <form action="{{ route('medical_records.destroy', $medicalRecord->id) }}"
                      method="POST"
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-gray-900 font-medium">{{ $medicalRecord->created_at->format('F d, Y \a\t h:i A') }}</p>
                </div>

                <div>
                    <p class="text-sm text-gray-600 mb-1">Last Updated</p>
                    <p class="text-gray-900 font-medium">{{ $medicalRecord->updated_at->format('F d, Y \a\t h:i A') }}</p>
                </div>
            </div>
        </div>
        ...
        @if(!$medicalRecord->symptoms && !$medicalRecord->diagnosis && !$medicalRecord->medication && (!$medicalRecord->medicalFiles || $medicalRecord->medicalFiles->count() === 0))
        <div class="p-6 border-b border-gray-200">
    ...
    <div class="mt-6 flex items-center justify-between bg-white p-4 rounded-lg shadow">
        <a href="{{ route('medical_records.index') }}" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">
