        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Day of
                            Week</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Start
                            Time</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">End
                            Time</th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-900">{{ ucfirst($schedule->day_of_week) }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($schedule->start_time)->format('h:i A') }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($schedule->end_time)->format('h:i A') }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @endphp
                                <span class="text-sm font-medium text-gray-900">{{ $totalSlots }} slots</span>
                                <span class="text-xs text-gray-500 block">{{ $totalMinutes }} min total</span>
                            </td>
