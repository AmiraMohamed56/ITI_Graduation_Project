        ...
        <div class="mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between py-2">
                    ...
                    <span class="text-gray-900 dark:text-gray-100 font-medium">{{ $doctor->years_experience }} years</span>
                </div>
                ...
                <div class="flex justify-between py-2">
                    ...
                    <span class="text-gray-900 dark:text-gray-100 font-medium">{{ number_format($doctor->consultation_fee, 2) }} EGP</span>
                </div>
