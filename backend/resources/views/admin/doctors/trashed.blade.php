...
@section('content')
    ...
    <div x-data="{ restoreModal: false, actionId: null }" class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                ...
                <table class="w-full text-left">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-sm font-medium text-gray-700 dark:text-gray-200">Deleted At</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($doctors as $doctor)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    {{ $doctor->years_experience }} Years</td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300 font-semibold">
                                    {{ $doctor->consultation_fee }} EGP</td>
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300 font-semibold">
                                    {{ $doctor->deleted_at ? $doctor->deleted_at->diffForHumans() : '—' }}</td>
        ...
        <div x-show="restoreModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div
                class="bg-white dark:bg-gray-800 rounded-xl p-6 w-96 shadow-xl border border-gray-200 dark:border-gray-700">
