...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-10 px-6 text-gray-900 dark:text-gray-100">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 overflow-hidden p-6">

            @if ($errors->any())
                <div class="mb-4 p-4 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-200 rounded border border-red-400 dark:border-red-700">
            ...
            <form action="{{ route('admin.doctors.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                           class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-1 focus:ring-blue-500" required>
                </div>
