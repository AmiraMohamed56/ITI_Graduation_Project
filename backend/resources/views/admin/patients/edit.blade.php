...
@section('breadcrumb')
    <a href="{{ route('admin.patients.index') }} " class="hover:underline">Patients</a> / <a href="{{ route('admin.patients.show', $patient) }}" class="hover:underline"><span>{{ $patient->user->name }}</span></a> / <span>edit</span>
@endsection
@section('content')
